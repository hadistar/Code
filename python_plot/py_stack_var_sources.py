...
plt.bar(Season, z.ss, color='C8',width=0.6,label="Secondary sulrfate",bottom=z.m+z.h+z.bb+z.cc+z.io+z.ism+z.sa+z.so)
...
# plt.savefig('D:\\GitHub\\Code\\python_plot\\ILCR_source.png')
plt.savefig('D:\\GitHub\\Code\\python_plot\\HQ_source.png')
plt.show()